                    ...
                    <div class="row">
                        <div class="col-md-9 post-content" data-aos="fade-up">
                            ...
                            <div class="single-post">
                                <div class="post-meta"><span class="date">Lingkungan</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="comment-name" placeholder="Masukan Nama Anda">
                                        </div>
                                        <div class="col-lg-6 mb-3">
                                            <label for="comment-email">Email</label>
                                            <input type="text" class="form-control" id="comment-email" placeholder="Masukan Email Anda">
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label for="comment-message">Pesan/Komentar</label>

                                            <textarea class="form-control" id="comment-message" placeholder="Berikan Komentar" cols="30" rows="10"></textarea>
                                        </div>
                                        <div class="col-12">
                                            <input type="submit" class="btn btn-primary" value="Posting Komentar Anda">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="aside-block">
                                ...
                                <ul class="nav nav-pills custom-tab-nav mb-4" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-popular-tab" data-bs-toggle="pill" data-bs-target="#pills-popular" type="button" role="tab" aria-controls="pills-popular" aria-selected="true">Terpopuler</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-trending-tab" data-bs-toggle="pill" data-bs-target="#pills-trending" type="button" role="tab" aria-controls="pills-trending" aria-selected="false">Informasi Terkini</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-latest-tab" data-bs-toggle="pill" data-bs-target="#pills-latest" type="button" role="tab" aria-controls="pills-latest" aria-selected="false">Artikel Terbaru</button>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                                        <div class="post-entry-1 border-bottom">
                                            <div class="post-meta"><span class="date">Pendidikan</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                            <h2 class="mb-2"><a href="#">How to Avoid Distraction and Stay Focused During Video Calls?</a></h2>
                                            <span class="author mb-3 d-block">Jenny Wilson</span>
                                        </div>

                                        <div class="post-entry-1 border-bottom">
                                            <div class="post-meta"><span class="date">Informasi Publik</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <div class="aside-block">
                                ...
                                <div class="video-post">
                                    <a href="https://youtu.be/26HfyNT2lxo?si=XgxLi5Lb8eolYr_a" class="glightbox link-video">
                                        <span class="bi-play-fill"></span>
                                        <img src="assets/img/Aplikasi-Jogja-Smart-Service.jpg" alt="" class="img-fluid">
                                    </a>
                                </div>
                            </div><!-- End Video -->
                            ...
                            <div class="aside-block">
                                ...
                                <ul class="aside-tags list-unstyled">
                                    <li><a href="category.html">Lingkungan</a></li>
                                    <li><a href="category.html">Hotspot Jogja</a></li>
                                    <li><a href="category.html">Pendidikan</a></li>
                                    <li><a href="category.html">Layanan JSS</a></li>
                                    <li><a href="category.html">Perizinan</a></li>
                                    <li><a href="category.html">Pengaduan</a></li>
                                    <li><a href="category.html">Lowongan Kerja</a></li>
                                    <li><a href="category.html">Gandeng Gendong</a></li>
                                </ul>
                            </div><!-- End Tags -->
                            ...
                            <ul class="footer-links footer-blog-entry list-unstyled">
                                <li>
                                    <a href="single-post.html" class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="post-meta d-block"><span class="date">Hotspot Jogja</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
